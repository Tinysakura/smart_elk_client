...
public interface QueryService {
    ...
    Observable<QueryResponse> search(@Path("index") String index, @Path("documentType") String documentType, @Body QueryBody queryBody, @Field("search_type") String searchType);
     ...
     */
    @POST("/{index}/_search/")
    Observable<QueryResponse> search(@Path("index") String index, @Body QueryBody queryBody, @Field("search_type") String searchType);
     ...
     */
    @POST("/{index}/{documentType}/_search/")
    Observable<QueryResponse> search(@Path("index") String index, @Path("documentType") String documentType, @Body QueryBody queryBody, @Field("search_type") String searchType, Class clazz);
     ...
     */
    @POST("/{index}/_search/")
    Observable<QueryResponse> search(@Path("index") String index, @Body QueryBody queryBody, @Field("search_type") String searchType, Class clazz);
